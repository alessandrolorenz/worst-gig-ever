...
| **M17.1 retune of `level01`** | **done 2026-09-05.** Measured over 200 seeds, two candidates tabled, owner chose the one that preserves the validated opening. The show now escalates on all three axes instead of one. Every device observation of the show from before this date is measured against a different round |
